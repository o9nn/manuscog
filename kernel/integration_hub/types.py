...
class IntegrationMessage:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "IntegrationMessage":
        ...
        return cls(
            header=header, payload=data["payload"], metadata=data.get("metadata", {})
        )
...
class GuidanceRequest:
    ...
    def to_message(self) -> IntegrationMessage:
        header = MessageHeader.create(
            direction=MessageDirection.TO_MANUS, priority=self.urgency
        )
...
class AnalysisRequest:
    ...
    def to_message(self) -> IntegrationMessage:
        header = MessageHeader.create(
            direction=MessageDirection.TO_MANUS, priority=MessagePriority.MEDIUM
        )
        return IntegrationMessage(
            header=header,
            payload={
...
class EvolutionProposal:
    ...
    def to_message(self) -> IntegrationMessage:
        header = MessageHeader.create(
            direction=MessageDirection.TO_MANUS, priority=MessagePriority.HIGH
        )
        return IntegrationMessage(
            header=header,
            payload={
...
class StatusReport:
    ...
    def to_message(self) -> IntegrationMessage:
        header = MessageHeader.create(
            direction=MessageDirection.TO_MANUS, priority=MessagePriority.LOW
        )
        return IntegrationMessage(
            header=header,
            payload={
